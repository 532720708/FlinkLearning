...
public class Kafka010Example {
    ...
    public static void main(String[] args) throws Exception {
        args = new String[]{"--input-topic", "test3", "--output-topic", "test4", "--bootstrap.servers", "192.168.253.151:9092",
                "--zookeeper.connect", "192.168.253.151:2181", "--group.id", "myconsumer1"};
